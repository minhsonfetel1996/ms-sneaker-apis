...
export class ProductsService {
  ...
  getById(id: string | Schema.Types.ObjectId): Promise<Products> {
    return this.productsRepository.findById({ id: id });
  }

  getByIdAndOnStock(id: string | Schema.Types.ObjectId): Promise<Products> {
  ...
  getProducts(filters, { limit, sort, page }): Promise<Pagination<Products>> {
